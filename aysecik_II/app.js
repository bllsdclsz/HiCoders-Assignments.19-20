...
let girilmesiGerekenSayiMiktari = new Number(bilgiAl("Kac tane sayi gireceksiniz?(orn:1,2)"));

for(let i=0;i<girilmesiGerekenSayiMiktari;i++){
...
convertStringstoNumbers(sayiDizisi, cevrilenSayilarinDizisi, toNumber);
let girilenSayilarinSayisi = sayiDizisi.length;

//let cevrilmisSayilar = (sayiDizisi, cevrilenSayilarinDizisi, toNumber);
